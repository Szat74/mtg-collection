    ...
    <div className="stats-view">
      ...
      <div className="stats-charts">
            ...
            <div key={r.rarity} className="bar-row">
              ...
              <div className="bar-track">
                <div
                  className="bar-fill"
                  style={{
                    width: `${(r.n / maxRarity) * 100}%`,
                    background: RARITY_COLOR[r.rarity] || '#888',
                  }}
                />
              </div>
        ...
        <div className="chart-block">
          <h3>By Deck</h3>
          {(stats.byDeck || []).map(d => (
            <div key={d.deck} className="bar-row">
          ...
          {(stats.byDeck || []).length === 0 && <p className="empty-note">No deck assignments yet.</p>}
        </div>
      </div>
    </div>
  );
